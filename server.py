        ...
        try:
          ...
          if token_exist(data["request"]["nlu"]["tokens"], u"цвет"):
            ...
            if token_partly_exist(data["request"]["nlu"]["tokens"], u"корид"):
              color = data["request"]["command"].replace(u" коридор","").encode('utf-8')
              color = data["request"]["command"].replace(u" в","").encode('utf-8')
              color = data["request"]["command"].replace(u" коридоре","").encode('utf-8')
